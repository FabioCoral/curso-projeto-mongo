package com.fabiocoral.workshopmongo.conifg;

import com.fabiocoral.workshopmongo.domain.Post;
import com.fabiocoral.workshopmongo.domain.User;
import com.fabiocoral.workshopmongo.dto.AuthorDTO;
import com.fabiocoral.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa vigem mano !", sdf.parse("21/03/2018"), new AuthorDTO(alex));
